...
export default function Project({
    ...
    return (
        ...
        className = "group mb-3 sm:mb-8 last:mb-0">
            ...
            <motion.section className = "bg-gray-100 max-w-[42rem] border border-black/5 rounded-lg overflow-hidden sm:pr-8 \
            relative sm:h-[20rem] mb-3 sm:mb-8 last:mb-0 even:pl-8 \
            hover:bg-gray-200 transition group-even:pl-8">
                <div className = "pt-4 pb-7 px-5 sm:pl-10 sm:max-w-[50%] flex flex-col h-full \
                group-even:ml-[18rem]">
