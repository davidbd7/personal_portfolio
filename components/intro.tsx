...
export default function Intro() {
    ...
    return (
        ...
        <motion.div className = "flex flex-col sm:flex-row justify-center gap-2 px-4 text-lg font-medium"
            ...
            hover:scale-110 active:scale-105 transition cursor-pointer border border-black/10" href = "/dec_29_david.pdf" download> Download CV <HiDownload className = "opacity-60 group-hover:translate-y-1 transition"/></a>
